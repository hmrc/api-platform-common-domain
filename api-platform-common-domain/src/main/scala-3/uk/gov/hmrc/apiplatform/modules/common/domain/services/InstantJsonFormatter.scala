...
object InstantJsonFormatter {
  ...
  object WithTimeZone {
    ...
    given instantWithTimeZoneFormat: Format[Instant] = Format(lenientInstantReads, instantWithTimeZoneWrites)
  }
  ...
  object NoTimeZone {
    ...
    given instantNoTimeZoneFormat: Format[Instant] = Format(lenientInstantReads, instantNoTimeZoneWrites)
  }
}
