...
class InstantJsonFormatterSpec extends BaseJsonFormattersSpec {
  ...
  "InstantJsonFormatter" should {
    ...
    "read from Json (WithTimeZone)" in {
      import uk.gov.hmrc.apiplatform.modules.common.domain.services.InstantJsonFormatter.WithTimeZone.given
    ...
    "read from Json (NoTimeZone)" in {
      import uk.gov.hmrc.apiplatform.modules.common.domain.services.InstantJsonFormatter.NoTimeZone.given
      testFromJson[Instant](""""2000-01-02T03:04:05.006Z"""")(instant)
      testFromJson[Instant](""""2000-01-02T03:04:05.006"""")(instant)
    }
